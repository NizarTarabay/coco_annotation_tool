#!/usr/bin/python
"""
this code is created by: akTwelve https://github.com/akTwelve
https://github.com/akTwelve/cocosynth
go to your project directory and run in the terminal:
...
class CocoJsonCreator():
    def validate_and_process_args(self, args):
        ...
        """
        # Validate the mask definition file exists (make sure the file exist)
